...
def data_get():
    city = city_name.get()
    data = requests.get("https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=7e310f628d2196c0032c7f0d2cae0971").json()
...
done_button.place(x=200,y=200,height=40,width=100)
